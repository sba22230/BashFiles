...
#INSERT INTO activity (home_id, datetime, code_used, event) VALUES (1, '2021-10-01 12:00:00', 'main', 'entry');
#SELECT * FROM activity;

#copy home_security.activity (home_id, datetime, code_used, event) FROM '/home/sba22230/Downloads/activity.csv' WITH HEADER = TRUE and delimiter = '|';
#copy home_security.home (home_id, address, city, state, zip, contact_name, phone, alt_phone, phone_password, email, main_code, guest_code) FROM '/home/sba22230/Downloads/home.csv' WITH HEADER = TRUE and delimiter = '|';
...
#USE employees;
#COPY employees.employees_data (employee_id, firstname, lastname, department, city) FROM '/home/sba22230/Downloads/employees_data.csv' WITH HEADER = true;
